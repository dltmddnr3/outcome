...
- [ ] B6: exact correction commit/tree/asset, changed paths, tests, rollout/rollback과 limitations가 immutable handoff로 전달된다.
  EVIDENCE: `docs/PHASE2_ACCOUNT_ACCESS_UX_QA_CORRECTION_EVIDENCE.md`에 base, red-first, final suites, changed behavior, rollout/rollback과 limitations를 기록했다. exact candidate object/asset은 최종 handoff에 고정한다.
