...
- Next: `K2 · provider, owner identity, session, revocation, CSRF and recovery decision`; K1은 2026-08-25 KST Cherry 승인으로 닫혔고 K2–K6 승인 전 인증·DB·secret·domain 제품 변경은 시작하지 않는다.
...
- Future roadmap visibility: Phase 2의 account access definition은 `K1 1/6 승인 · K2–K6 Cherry 결정 대기` 상태로 source-visible하다. Phase 4와 5는 roadmap container이며 Phase 3은 `Definition Pending`으로 어떤 진행도 추론하지 않는다.
