...
- [ ] 공개 고정 URL의 exact commit/tree/asset, GET 200, mutation 405, prohibited hit 0을 확인한다.
- [x] Cherry acceptance와 외부 완료 판정은 별도 미결 경계로 남긴다.

EVIDENCE: 프런트엔드 57 + Node 78, 브라우저 assertion 16, production/isolated build 통과. 네 viewport 모두 clipped/ellipsis/intersections/viewportEscape/documentOverflow 0. 공개 증거는 배포 후 기록한다.
