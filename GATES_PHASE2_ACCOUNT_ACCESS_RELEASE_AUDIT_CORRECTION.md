...
- [ ] R5: exact commit/tree/asset, changed paths, red/final commands, limitations와 rollback이 immutable Builder handoff로 전달된다.
  EVIDENCE: correction evidence doc에 base, red/final commands, fixture-only limitation과 rollback을 기록했다. Exact candidate object/asset은 post-commit handoff에 고정한다.
