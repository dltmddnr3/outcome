...
console.log(`scope PASS: ${files.length} product/runtime/test files; no Desk, Slack, relay, or unapproved provider dependencies; Clerk backend and React SDK pinned`)
