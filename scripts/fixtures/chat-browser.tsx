...
import { focusPlannerConversation } from '../../src/components/OutcomeDashboard'
...
createRoot(document.getElementById('root')!).render(<main>
  ...
  <button onClick={() => focusPlannerConversation()}>Planner 대화 보기</button>
  <details className="oc-v1-compatibility" open><summary>합성 호환 정보</summary><div id="oc-planner-conversation">
