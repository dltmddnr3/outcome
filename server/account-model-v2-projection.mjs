...
const validateSourceContract = (source) => {
  ...
  if (source.resultView !== undefined && source.resultView !== null) {
    ...
    if (source.resultView.source_projection !== undefined) {
      ...
      for (const conflict of context.conflicts) assertKeys(conflict, new Set(['code', 'map_value', 'gate_value']))
